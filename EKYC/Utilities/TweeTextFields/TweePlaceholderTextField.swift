...
open class TweePlaceholderTextField: UITextField {
	...
	@objc public func minimizePlaceholder() {
		...
		UIView.animate(withDuration: placeholderDuration, delay: 0, options: [.preferredFramesPerSecond30], animations: {
			...
			case .immediately:
				...
				self.placeholderLabel.font = UIFont.init(name: "MessinaSans-Black", size: self.minimumPlaceholderFontSize) //self.placeholderLabel.font.withSize(self.minimumPlaceholderFontSize)
			case .smoothly:
	...
	@objc private func minimizePlaceholderFontSize() {
		...
		DispatchQueue.main.async {
			...
			self.placeholderLabel.font = UIFont.init(name: "MessinaSans-Black", size:fontSize)
	...
	@objc public func maximizePlaceholder() {
		...
		UIView.animate(withDuration: placeholderDuration, delay: 0, options: [.preferredFramesPerSecond60], animations: {
			...
			self.placeholderLabel.font = UIFont.init(name: "MessinaSans-Black", size:self.originalPlaceholderFontSize)
	...
	@objc private func maximizePlaceholderFontSize() {
		...
		DispatchQueue.main.async {
			...
			self.placeholderLabel.font = UIFont.init(name: "MessinaSans-Black", size:size)
